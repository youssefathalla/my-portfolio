...
- 👤 **Human Responsibility**:
  ...
  2. In Identity Platform / Firebase Auth settings, enable **Email enumeration protection** to prevent attackers from discovering registered accounts.
- 🤖 **AI Responsibility**:
...
|  [x]   | **Auth Protection**    | Enable Email Enumeration Protection               | Verified active via Google Identity Toolkit API (`enableImprovedEmailPrivacy: True`). Authorized domains restricted to project domains.                                                                                                                              |
