...
description: Decide where localized text lives and how it is organized. Use when setting up locales or routing for a language, creating or moving a *.content.ts file, choosing between a transloco JSON key and a typed content record, organizing content for a new feature, or adding a new language.
---
