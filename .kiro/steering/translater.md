...
inclusion: auto
name: translater
description: Translate a component, page, or section into multiple languages. Use when localizing component strings into colocated <feature>.content.ts dictionaries.
---
